var monsters={
	...
	"crabxx":{
		"skin":"crabx",
		"name":"Giga Crab","speed":30,"charge":80,"hp":50000,"xp":720000,"attack":1500,"damage_type":"physical","respawn":-1,"gold":120,"range":45,"size":1.5,"frequency":0.3,"aggro":0,
			"armor":320,
		"difficulty":10,
		"special":true,
		"phresistance":30,
	...
	"rgoo":{
		"name":"Rainbow Goo","skin":"gooD","speed":9,"hp":50000,"xp":48000000,"attack":320,"damage_type":"physical","respawn":-1,"gold":240,"range":64,"frequency":1.2,"aggro":0.1,"aa":1,
		"armor":300,
		"resistance":300,
		"size":1.5,
		"cooperative":true,
	...
	"icegolem":{
		"name":"Ice Golem","speed":12,"charge":48,"hp":500000,"xp":92000000,"attack":2400,"damage_type":"physical","respawn":-1,"gold":1,"range":64,"frequency":1.2,"aggro":0.2,"resistance":800,"armor":800,
		"announce":true,
		"special":true,
		"phresistance":40,
		"difficulty":12,
	...
	"franky":{
		"name":"Franky","speed":48,"charge":64,"hp":2000000,"xp":200000000,"attack":2910,"damage_type":"magical","hit":"explode_c","respawn":-1,"gold":10000,"range":948,"frequency":1.6,"aggro":1,"rage":0,"special":true,"cooperative":true,"spawns":[[200,"nerfedmummy"]],"announce":"#9D99EF",
		"phresistance":70,
		"humanoid":true,
		"achievements":[
			[1,"stat","for",1],
...
for(var name in monsters){
	if(!monsters[name]["skin"]) monsters[name]["skin"]=name;
	if(!monsters[name]["rage"]) monsters[name]["rage"]=0;
	if(!monsters[name]["aggro"]) monsters[name]["aggro"]=0;
	if(!monsters[name]["mp"]) monsters[name]["mp"]=Math.ceil(monsters[name]["hp"]*2/100);
	monster_gold[name]=monsters[name]["gold"]||1;
	try{ delete monsters[name]["gold"]; }
	catch(e){}
}
